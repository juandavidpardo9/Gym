 ...
 * @author david
 */
public class ObesidadSevera extends TipoDeCliente implements Cardio {

    @Override
    public String ejercicioCardio() {
        String cardio="Despues de realizar las rutinas de ejercicio debe realizar ejercicios cardiovasculares de 15 a 20 minutos para ir perdiendo grasa y mejorar resistencia.";
        return cardio;
    }
      @Override
   public String calentar() {
    ...
    public String rutinaPiernas() {
        String piernas="Realiza los siguientes ejercicios: Elevación de pelvis en colchoneta, Sentadillas , Peso muerto con barra más 5 libras,  Elevación de pierna en banca,  Elevación de talones. Realiza 3 sesiones de 10 repeticiones en cada ejercicio."; 
        return piernas;
    }

    @Override
    public String rutinaPecho() {
        String pecho="Realiza los siguientes ejercicios: Comienza con un calentamiento haciendo flexiones de pecho en el piso, despues puedes comenzar con el press de banca inclinado, continuando con press de banca en declive y press de banca horizontal. Puedes utilizar mancuernas de 3 libras, realiza 3 sesiones de 10 repeticiones.  ";
        return pecho;
    }

    @Override
    public String rutinaEspalda() {
        String espalda="Realiza los siguientes ejercicios: Remo con barra, jaones al pecho, remo con polea baja, remo en maquina horizontal, peso muerto; Realiza 3 sesiones de 10 repeticiones con un peso de 5 libras. ";
        return espalda;
    }
}
